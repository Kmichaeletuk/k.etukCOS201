...
int main() {
    ...
    std::vector<Question> questions = {
        ...
        {"Which type of memory is used by an Array in C++ programming language?",{"Continguos", "None - Continguos", "Both A and B","Not mentioned"}, 'A'}
        {"Which one of the following is the correct definition of the "is_array();" function in C++?",{"It checks that the specified variable is of the array or not", "It checks that the specified array of single dimension or not", "It checks that the array specified of multi-dimension or not", "Both B and C" } , 'A'}
    };
